...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'StreakPage')
              : StreakPageWidget(),
        ),
        FFRoute(
          name: ReferralPageWidget.routeName,
          path: ReferralPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'ReferralPage')
              : ReferralPageWidget(),
        ),
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'HelpPage')
              : HelpPageWidget(),
        ),
        FFRoute(
          name: CongratulationsPageWidget.routeName,
          path: CongratulationsPageWidget.routePath,
