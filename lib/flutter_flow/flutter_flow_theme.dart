...
abstract class FlutterFlowTheme {
  ...
  late Color black;
  late Color warningTransparancy50;
  late Color fireSecondary;
  late Color fire;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF00539B);
  late Color secondary = const Color(0xFF0793CF);
  late Color tertiary = const Color(0xFFEE3325);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF002341);
  late Color accent2 = const Color(0xFF02405B);
  late Color accent3 = const Color(0xFF8E3933);
  ...
  late Color black = Color(0x33000000);
  late Color warningTransparancy50 = Color(0x80F59E0B);
  late Color fireSecondary = Color(0xFFFFEDD5);
  late Color fire = Color(0xFFF97316);
  late Color successDark = Color(0xFF08795A);
  late Color successLight = Color(0xFFCFFCE6);
  late Color disabled = Color(0xFF97A4AD);
}
